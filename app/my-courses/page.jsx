        ...
        <div className="min-h-screen bg-slate-50 pt-24 md:pt-32 pb-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 md:mb-12 animate-fade-in-up">
                    ...
                    <h1 className="text-3xl md:text-5xl font-bold text-gray-900 tracking-tight mb-3 md:mb-4 leading-tight">
                        My <span className="text-indigo-600 font-bold">Enrolled</span> Courses
                    </h1>
                ...
                {courses.length === 0 ? (
                    <div className="text-center bg-white p-8 md:p-16 rounded-xl shadow-sm border border-slate-200 animate-fade-in">
                        ...
                        <Link
                            href="/courses"
                            className="inline-flex items-center px-6 md:px-8 py-2.5 md:py-3 rounded-lg bg-indigo-600 text-white text-sm md:text-base font-bold hover:bg-indigo-700 transition-all active:scale-95 shadow-sm shadow-indigo-100"
                        >
                            Browse Courses
                        </Link>
                    </div>
