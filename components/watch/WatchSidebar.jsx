...
export default function WatchSidebar({ modules, activeLesson, onLessonSelect, completedLessons = [], isOpen, onClose }) {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-20 w-80 lg:w-96 bg-white border-r border-slate-200 flex flex-col h-full overflow-hidden shrink-0 shadow-2xl lg:shadow-sm lg:static transition-transform duration-300 transform 
