...
export default function WatchContent({ activeLesson, course, isCompleted, onToggleComplete }) {
    ...
    return (
        <main className="flex-1 flex flex-col overflow-y-auto min-h-full bg-white">
            ...
            <div className="flex-1 px-4 lg:px-8 py-6 scrollbar-thin scrollbar-thumb-slate-300">
                <div className="max-w-[1400px] mx-auto">
                    {/* Lesson Header */}
